...
import com.szxb.lib.base.theme.AppThemeSetting;
import com.szxb.lib.base.theme.ThemeFactory;
...
public class MI2App {
    ...
    public void gotoSetting() {
        ...
        if (Build.VERSION.SDK_INT >= 9) {
            ...
            intent.putExtra("com.android.settings.ApplicationPkgName", application.getPackageName());
        }
