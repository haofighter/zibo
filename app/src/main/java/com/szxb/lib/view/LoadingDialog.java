...
public class LoadingDialog {
    ...
    private boolean initDailog() {
        ...
        if (d == null) {
            View view = View.inflate(BusApp.getInstance().getNowActivitie(), R.layout.common_loadingdialog, null);
...
//            ad.start();
            ...
            d = new Dialog(BusApp.getInstance().getNowActivitie(), R.style.dialog);// 加入样式
