...
import com.szxb.lib.Util.DialogUtils
import com.szxb.lib.Util.ToastUtils
import com.szxb.lib.base.BackCall
import com.szxb.lib.base.MI2App
import com.szxb.out.base.utils.listener.SearchFileLisener
import com.szxb.out.base.utils.listener.TraverseFileListener
...
object SystemUtils {
    ...
    fun traverseFile(
        ...
        if (BusApp.getInstance().nowActivitie != null) {
            BusApp.getInstance().nowActivitie!!.runOnUiThread(object : Runnable {
                override fun run() {
    ...
    fun searchFlie(
        ...
        if (ActivityCompat.checkSelfPermission(
                        BusApp.getInstance().application,
                                ...
                                R.id.confirm -> {
                                    if (BusApp.getInstance().nowActivitie != null) {
                                        ActivityCompat.requestPermissions(
                                                BusApp.getInstance().nowActivitie!!,
