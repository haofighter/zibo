...
public class BankScanPay {
    ...
    public Iso8583Message qrPayMessage(String qrCode, int amount, long seq, String macKey) {
    ...
    private Iso8583Message qrPayMessageData(String qrCode, long seq, int amount) {
