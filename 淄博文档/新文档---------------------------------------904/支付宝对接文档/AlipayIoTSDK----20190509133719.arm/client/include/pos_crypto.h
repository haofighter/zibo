...
/**
 * 重庆一码通码信息
 * @oaram:char* access_inst_code接入机构编号
 * @oaram:int access_inst_code_len 
 * @oaram:char* access_inst_cert_no 接入机构证书号
 * @oaram:int access_inst_cert_no_len 
 * @oaram:char* access_app_no 接入应用号
 * @oaram:int access_app_no_len
 * @oaram:unsigned char* code_issuer_reserve_data 发码机构保留数据
 * @oaram:int code_issuer_reserve_data_length
 * @oaram:char* code_issuer_cert_no 发码机构证书号
 * @oaram:int code_issuer_cert_no_len 
 * @oaram:char* card_no 卡号
 * @oaram:int card_no_len
 * @oaram:char* card_valid_no 卡号验证码
 * @oaram:int card_valid_no_len
 * @oaram:unsigned char* payer_flag_data 支付用户标示数据
 * @oaram:int payer_flag_length
 * @oaram:unsigned char* access_inst_reserve_data 接入机构保留数据
 * @oaram:int access_inst_reserve_data_length
 * @oaram:unsigned char* operate_inst_reserve_data 运营机构保留数据
 * @oaram:int operate_inst_reserve_data_length
 */
typedef struct _cqymt_code_info{
	char* access_inst_code;
	int access_inst_code_len;
	char* access_inst_cert_no;
	int access_inst_cert_no_len;
	char* access_app_no;
	int access_app_no_len;
	unsigned char* code_issuer_reserve_data;
	int code_issuer_reserve_data_length;
	char* code_issuer_cert_no;
	int code_issuer_cert_no_len;
	char* card_no;
	int card_no_len;
	char* card_valid_no;
	int card_valid_no_len;
	unsigned char* payer_flag_data;
	int payer_flag_length;
	unsigned char* access_inst_reserve_data;
	int access_inst_reserve_data_length;
	unsigned char* operate_inst_reserve_data;
	int operate_inst_reserve_data_length;
}CQYMT_CODE_INFO;
...
typedef struct _code_info{
	...
	CQYMT_CODE_INFO cqymt_code_info;
}CODE_INFO;
/**
 * 获取二维码信息 响应
